...
```{r}
# load datasets
covar_df <- read_csv("/Users/chloehampson/Desktop/abcd-plsc/derivatives/none-reduced-no-motion/covariate.csv")
socio_df <- read_csv("/Users/chloehampson/Desktop/abcd-plsc/derivatives/none-reduced-no-motion/clean-socio.csv")
rsfc_df <- read_csv("/Users/chloehampson/Desktop/abcd-plsc/derivatives/none-reduced-no-motion/clean-rsfc.csv")


fig_dir <- "/Users/chloehampson/Desktop/abcd-plsc/derivatives/none-reduced-no-motion/figures/"
dir.create(fig_dir, showWarnings = FALSE, recursive = TRUE)
out_dir <- "/Users/chloehampson/Desktop/abcd-plsc/derivatives/none-reduced-no-motion"
...
lm.Group1 <- lm(Group1.Y ~ Group1.X$interview_age +
  ...
  as.factor(Group1.X$mri_info_manufacturer), na.action = na.omit)
