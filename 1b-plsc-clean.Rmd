...
socio_colors <- rep("black", nrow(BR.J))
socio_colors[7] <- "#6FBFE1"
socio_colors[10] <- "#9BF1FE"
socio_colors[2] <- "#90CEC1"
socio_colors[3] <- "#BCE3C8"
socio_colors[8] <- "#90CEC1"
socio_colors[9] <- "#BCE3C8"
socio_colors[15] <- "#D2F3D8"
