...
socio_df <- read_csv("/Users/chloehampson/Desktop/projects/abcd-plsc/derivatives-reduced/sociocult_8.csv")
...
plotSalience_fn <- function(set, dimension) {
 ...
 # Set up the layout to have 2 rows and 3 columns for the salience plots
 par(mfrow = c(2, 3), mar = c(5, 4, 4, 2)) # Adjust margins as needed

 # Plot salience for X (top row)
