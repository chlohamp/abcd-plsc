...
plotSalience_fn <- function(set, dimension) {
 ...
 # Set the file path for saving the plot
 png(file.path(fig_dir, "Salience_XDim3.png"), width = 1800, height = 1200, res = 200)
 ...
 dev.off()
  ...
  png(file.path(fig_dir, "Salience_YDim3.png"), width = 1800, height = 1200, res = 200)
...
png(file.path(fig_dir, "Bootstrap_Ratio_BRI_Dim3.png"), width = 1800, height = 1200, res = 200)
...
png(file.path(fig_dir, "Bootstrap_Ratio_BRJ_Dim3.png"), width = 1800, height = 1200, res = 200)
