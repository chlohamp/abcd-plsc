...
```{r}
# load datasets
covar_df <- read_csv("/Users/chloehampson/Desktop/projects/abcd-plsc/derivatives/none-reduced/covariate.csv")
socio_df <- read_csv("/Users/chloehampson/Desktop/projects/abcd-plsc/derivatives/none-reduced/sociocult.csv")
rsfc_df <- read_csv("/Users/chloehampson/Desktop/projects/abcd-plsc/derivatives/none-reduced/rsfc.csv")
# phy_df <- read_csv("/Users/chloehampson/Desktop/projects/abcd-plsc/derivatives/phyhealth.csv")

fig_dir <- "/Users/chloehampson/Desktop/projects/abcd-plsc/derivatives/none-reduced/figures/"
out_dir <- "/Users/chloehampson/Desktop/projects/abcd-plsc/derivatives/none-reduced"
...
air_res <- cbind.data.frame(socio_loadings, air_bootstrap)
rni_res <- cbind.data.frame(rest_loadings, rni_bootstrap)

write.csv(air_res, paste(fig_dir,
  "rni-sociocult_Q-components.csv",
  sep = "/"
), row.names = TRUE)

write.csv(rni_res, paste(fig_dir,
...
png(file.path(fig_dir, "Bootstrap_Ratio_BRI_Dim6.png"), width = 1800, height = 1200, res = 200)
...
png(file.path(fig_dir, "Bootstrap_Ratio_BRJ_Dim6.png"), width = 1800, height = 1200, res = 200)
